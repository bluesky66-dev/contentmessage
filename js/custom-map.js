  ...
  function initialize() {
         //add map, the type of map
           var mapOptions = {
               ...
               center: new google.maps.LatLng(51.514771,-0.123790), // area location
         ...
         //add locations
             var locations = [
                 ['<div class"info-window"><div class="image-label"><img class="img-responsive" src="images/map_image.jpg" alt="featured-properties-5"><label>On Sale</label></div><div class="map-detail"><a href="#"><h4>Pear Apartments</h4></a><p>S California Ave</p><span>Beds:4</span><span> Baths:2</span><span> SqFt:1200</span></div></div>',
				  51.514771,-0.123790,'images/map_marker.png'],
                 ['<div class"info-window"><div class="image-label"><img class="img-responsive" src="images/map_image.jpg" alt="featured-properties-5"><label>On Sale</label></div><div class="map-detail"><a href="#"><h4>Luxury Family Home</h4></a><p>S California Ave</p><span>Beds:4</span><span> Baths:2</span><span> SqFt:1200</span></div></div>', 51.514771,-0.123790,'images/map_marker.png'],
				 ['<div class"info-window"><div class="image-label"><img class="img-responsive" src="images/map_image.jpg" alt="featured-properties-5"><label>On Sale</label></div><div class="map-detail"><a href="#"><h4>Luxury Family Home</h4></a><p>S California Ave</p><span>Beds:4</span><span> Baths:2</span><span> SqFt:1200</span></div></div>', 51.514771,-0.123790,'images/map_marker.png'],
				 ['<div class"info-window"><div class="image-label"><img class="img-responsive" src="images/map_image.jpg" alt="featured-properties-5"><label>On Sale</label></div><div class="map-detail"><a href="#"><h4>Luxury Family Home</h4></a><p>S California Ave</p><span>Beds:4</span><span> Baths:2</span><span> SqFt:1200</span></div></div>', 51.514771,-0.123790,'images/map_marker.png'],
             ];
